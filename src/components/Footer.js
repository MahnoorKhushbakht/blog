...
function Footer() {
  ...
  return (
    <footer class="bg-red-300 shadow-2xl shadow-red-300/10 body-font">
    <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-red-200">
      ...
      <div class="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav class="list-none mb-10">
            <li>
              <a class="text-white hover:text-red-500">First Link</a>
            </li>
            <li>
              <a class="text-white hover:text-red-500">Second Link</a>
            </li>
            <li>
              <a class="text-white hover:text-red-500">Third Link</a>
            </li>
            <li>
              <a class="text-white hover:text-red-500">Fourth Link</a>
            </li>
          </nav>
        </div>
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
