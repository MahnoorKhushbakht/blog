...
export default function Circle() {
  const circles = [
    { 
      icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-30 text-white">
    ...
    <div className="absolute inset-0 overflow-visible z-0 grid grid-cols-7 min-h-screen min-w-full gap-6">
      {circles.map((item, index) => (
        <motion.div
          ...
          initial={{ opacity: 0 }}       // Initial opacity when circles are out of view
          whileInView={{ opacity: 0.2 }} // Opacity when the circles come into view
